	...
	return (
		...
		>
			...
			<p className='contact-subtitle'>
				I am always open to discussing potential collaborations, innovative
				projects, and professional opportunities that align with
				...
				<div className='contact-cards'>
					...
					>
						...
						<div className='contact-card-content'>
							...
							<p className='contact-value'>
								linkedin.com/in/mohamed-nowfal-m-0941b1378
							</p>
						</div>
					</a>
					<a
					...
					>
						...
						<div className='contact-card-content'>
							...
							<p className='contact-value'>leetcode.com/u/MohamedNowfal18</p>
						</div>
					</a>
				</div>
			...
			<footer className='contact-footer'>
				<p>
					© 2026 Mohamed Nowfal. Designed and developed with a focus on
					performance, usability, and modern web standards.
				</p>
			</footer>
		</section>
	);
